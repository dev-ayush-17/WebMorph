...
const BASE_PRODUCTS = [
  { name: 'Concepts of Physics Part 1 — H C Verma',              basePrice: 320, slug: 'concepts-of-physics-part-1-hc-verma' },
  { name: 'Concepts of Physics Part 2 — H C Verma',              basePrice: 320, slug: 'concepts-of-physics-part-2-hc-verma' },
  { name: 'University Physics — Young & Freedman',               basePrice: 895, slug: 'university-physics-young-freedman' },
  { name: 'Introduction to Electrodynamics — Griffiths',         basePrice: 750, slug: 'introduction-to-electrodynamics-griffiths' },
  { name: 'The Feynman Lectures on Physics Vol 1',               basePrice: 999, slug: 'feynman-lectures-on-physics-vol-1' },
  { name: 'The Feynman Lectures on Physics Vol 2',               basePrice: 999, slug: 'feynman-lectures-on-physics-vol-2' },
  { name: 'The Feynman Lectures on Physics Vol 3',               basePrice: 999, slug: 'feynman-lectures-on-physics-vol-3' },
  { name: 'Optics — Ajoy Ghatak',                                basePrice: 425, slug: 'optics-ajoy-ghatak' },
  { name: 'Classical Mechanics — H Goldstein',                   basePrice: 680, slug: 'classical-mechanics-goldstein' },
  { name: 'Quantum Mechanics — Griffiths',                       basePrice: 695, slug: 'quantum-mechanics-griffiths' },
  { name: 'Thermal Physics — Kittel & Kroemer',                  basePrice: 580, slug: 'thermal-physics-kittel-kroemer' },
  { name: 'Electricity and Magnetism — Griffiths',               basePrice: 599, slug: 'electricity-magnetism-griffiths' },
  ...
  { name: 'Problems in General Physics — Irodov',                basePrice: 195, slug: 'problems-general-physics-irodov' },
  { name: 'Engineering Physics — M N Avadhanulu',                basePrice: 265, slug: 'engineering-physics-avadhanulu' },
  { name: 'Waves and Oscillations — N Subramaniam',              basePrice: 220, slug: 'waves-and-oscillations-subramaniam' },
  { name: 'Modern Physics — Murugeshan & Kiruthiga',             basePrice: 285, slug: 'modern-physics-murugeshan' },
  { name: 'Statistical Mechanics — R K Pathria',                 basePrice: 795, slug: 'statistical-mechanics-pathria' },
  { name: 'Mathematical Methods for Physicists — Arfken',        basePrice: 895, slug: 'mathematical-methods-physicists-arfken' },
  { name: 'Classical Electrodynamics — J D Jackson',             basePrice: 960, slug: 'classical-electrodynamics-jackson' },
  { name: 'Quantum Mechanics — L I Schiff',                      basePrice: 550, slug: 'quantum-mechanics-schiff' },
  { name: 'Atomic and Nuclear Physics — S N Ghoshal',            basePrice: 310, slug: 'atomic-nuclear-physics-ghoshal' },
  { name: 'Electromagnetic Field Theory — Hayt',                 basePrice: 430, slug: 'electromagnetic-field-theory-hayt' },
  { name: 'Physics for Scientists and Engineers — Serway',       basePrice: 825, slug: 'physics-scientists-engineers-serway' },
  { name: 'Fundamentals of Physics — Halliday Resnick Krane',    basePrice: 875, slug: 'fundamentals-physics-halliday-resnick' },
  ...
  { name: 'Astrophysics for Physicists — Choudhuri',             basePrice: 395, slug: 'astrophysics-physicists-choudhuri' },
  ...
  { name: 'Quantum Field Theory — Peskin & Schroeder',           basePrice: 1150, slug: 'quantum-field-theory-peskin-schroeder' },
  { name: 'General Relativity — Wald',                           basePrice: 870, slug: 'general-relativity-wald' },
  { name: 'An Introduction to Mechanics — Kleppner',             basePrice: 620, slug: 'introduction-mechanics-kleppner' },
  { name: 'Vibrations and Waves — French',                       basePrice: 280, slug: 'vibrations-waves-french' },
  { name: 'A Course of Modern Analysis — Whittaker Watson',      basePrice: 450, slug: 'course-modern-analysis-whittaker' },
  { name: 'Atomic Spectra and Atomic Structure — Herzberg',      basePrice: 340, slug: 'atomic-spectra-structure-herzberg' },
  { name: 'Introduction to Quantum Mechanics — Pauling',         basePrice: 390, slug: 'introduction-quantum-mechanics-pauling' },
  { name: 'Physics of Atoms and Molecules — Bransden',           basePrice: 660, slug: 'physics-atoms-molecules-bransden' },
  { name: 'Condensed Matter Physics — Marder',                   basePrice: 840, slug: 'condensed-matter-physics-marder' },
  { name: 'Particle Physics — Martin & Shaw',                    basePrice: 555, slug: 'particle-physics-martin-shaw' },
  { name: 'Nuclear and Particle Physics — Burcham',              basePrice: 610, slug: 'nuclear-particle-physics-burcham' },
  { name: 'Cosmology — Weinberg',                                basePrice: 920, slug: 'cosmology-weinberg' },
  { name: 'The Physics of Superheroes — Kakalios',               basePrice: 299, slug: 'physics-superheroes-kakalios' },
  { name: 'Thirty Years That Shook Physics — Gamow',             basePrice: 175, slug: 'thirty-years-shook-physics-gamow' },
  ...
  { name: 'Gravitation — Misner Thorne Wheeler',                 basePrice: 1200, slug: 'gravitation-misner-thorne-wheeler' },
  ...
  { name: 'Optical Fiber Communications — Keiser',               basePrice: 495, slug: 'optical-fiber-communications-keiser' },
  { name: 'Physics of Semiconductor Devices — Sze',              basePrice: 720, slug: 'physics-semiconductor-devices-sze' },
  { name: 'Magnetism and Magnetic Materials — Coey',             basePrice: 840, slug: 'magnetism-magnetic-materials-coey' },
  ...
  { name: 'Electronics and Optoelectronics — Wilson',            basePrice: 575, slug: 'electronics-optoelectronics-wilson' },
  ...
  { name: 'Cryogenic Engineering — T M Flynn',                   basePrice: 690, slug: 'cryogenic-engineering-flynn' },
  { name: 'Acoustics — Kinsler & Frey',                          basePrice: 540, slug: 'acoustics-kinsler-frey' },
  { name: 'Geometrical Optics — R S Longhurst',                  basePrice: 320, slug: 'geometrical-optics-longhurst' },
  { name: 'Crystal Physics — Bhagavantam',                       basePrice: 230, slug: 'crystal-physics-bhagavantam' },
  { name: 'Radiation Detection and Measurement — Knoll',         basePrice: 780, slug: 'radiation-detection-measurement-knoll' },
  { name: 'Quantum Optics — Walls & Milburn',                    basePrice: 820, slug: 'quantum-optics-walls-milburn' },
...
const BROKEN_GENERATORS = [
  ...
  () => {
    ...
    return products.map((p, i) =>
      i % 4 === 0 ? { product_name: p.product_name, product_url: p.product_url, currency: 'INR', scraped_at: p.scraped_at } : p
    );
  },
];
...
function generateMockProducts() {
  ...
  const products = generateHealthyProducts();
  console.log(`[mock-source] ✓  Generated ${products.length} healthy products (Raajkart Physics mock)`);
  return products;
}
